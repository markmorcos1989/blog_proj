...
class update_post{
	...
	function delete_prev_pic_link($search_post)
	{	if($search_post[0]['image'] != 'images/posts/default.PNG')
		{
			@unlink($search_post[0]['image']);
		}
	}
	
	function updatepost($table, $data, $num_sets, $type)
	{
