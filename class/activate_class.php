...
class activate {
	...
	function validation($security_code)
	{
		$this->errors=array();
		...
		if(!$security_code)
		{
			...
			$this->errors[] = "plz enter the security code";
		}
		else if($_SESSION['security_code'] != $security_code)
		{
			$this->errors[] = "incorrect, try again";
			$_SESSION['security_code']=rand(1000, 9999);
		}
	}

	function activate_user($table, $data, $num_sets, $type)
	{
